...
const ORDER_ASC = "order by p.createdAt desc";

// "select p.id, p.text, p.createAt, u.userid, u.name, url from users as u join posts as p on u.idx = p.useridx order by p.createdAt desc"
